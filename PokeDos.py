...
def banner(): # Banner
    ...
    print(fr"""
                ...
                {Fore.RESET}╔═════════════════════════════════╗
                {Fore.RESET}║       {Fore.LIGHTCYAN_EX}Layer4 Stress Test       {Fore.RESET} ║
                {Fore.RESET}║ {Fore.LIGHTCYAN_EX}DEV       PokeHooK              {Fore.RESET}║
                {Fore.RESET}╚═════════════════════════════════╝
                       {Fore.RESET}╔═════════════════╗
                       {Fore.RESET}║     {Fore.LIGHTCYAN_EX}Metodos     {Fore.RESET}║
                       {Fore.RESET}╚═════════════════╝
                     {Fore.RESET}╔═════════════════════╗     
...
if len(sys.argv) !=5: # Get Arguments
    print(f"""
          {Fore.RESET}╔═════════════════════════════════════════════════════╗
          {Fore.RESET}║ {Fore.LIGHTCYAN_EX}python3 PokeDos.py <ip> <puerto> <tiempo> <metodos> {Fore.RESET}║
          {Fore.RESET}╚═════════════════════════════════════════════════════╝
    """)
    sys.exit(1)
